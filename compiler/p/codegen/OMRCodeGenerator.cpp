...
void OMR::Power::CodeGenerator::apply64BitLoadLabelRelativeRelocation(TR::Instruction *lastInstruction, TR::LabelSymbol *label)
   ...
   // patchAddr-3   ori    tempReg, tempReg, (hiAddr>>16) & 0x0000ffff
   // patchAddr-2   lis    baseReg, hiAddr & 0x0000FFFF
   ...
   TR_ASSERT((lastPPCInstruction->getOpCodeValue() == TR::InstOpCode::ldu || lastPPCInstruction->getOpCodeValue() == TR::InstOpCode::ld) &&
           lastPPCInstruction->getPrev()->getPrev()->getOpCodeValue() == TR::InstOpCode::lis &&
           lastPPCInstruction->getPrev()->getPrev()->getPrev()->getOpCodeValue() == TR::InstOpCode::ori &&
