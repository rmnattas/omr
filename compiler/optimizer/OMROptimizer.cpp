...
bool OMR::Optimizer::areNodesEquivalent(TR::Node *node1, TR::Node *node2,  TR::Compilation *_comp, bool allowBCDSignPromotion)
   ...
   if (opCode1.isSwitch() == 0)
      ...
      if (opCode1.isLoadConst())
         ...
         TR::AutomaticSymbol * pinning1 = (node1->getOpCode().hasPinningArrayPointer() || node1->isDataAddrPointer()) ? node1->getPinningArrayPointer() : NULL;
         TR::AutomaticSymbol * pinning2 = (node2->getOpCode().hasPinningArrayPointer() || node2->isDataAddrPointer()) ? node2->getPinningArrayPointer() : NULL;
