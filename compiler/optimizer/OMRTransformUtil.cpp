...
TR::Node *
OMR::TransformUtil::generateArrayAddressTrees(TR::Compilation *comp, TR::Node *arrayNode, TR::Node *offsetNode)
   {
...
TR::Node *
OMR::TransformUtil::generateArrayStartTrees(TR::Compilation *comp, TR::Node *arrayObject)
   {
...
TR::Node *
OMR::TransformUtil::generateArrayOffsetTrees(TR::Compilation *comp, TR::Node *indexNode, TR::Node *elementSizeNode, int32_t elementSize, bool useShiftOpCode)
   {
