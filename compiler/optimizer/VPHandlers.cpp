  ...
  bool usingAladd = (vp->comp()->target().is64Bit()
   ...
   if (node->getFirstChild()->isDataAddrPointer())
      ...
      if ((offset->getOpCode().isAdd() || offset->getOpCode().isSub()) &&
         ...
         //       aload (array object)
         //   ladd/lsub (offset)
         //     lmul/lshl OR array_index (offset2)
         //       i2l
         //         iload array_index
         //       lconst mul_stride/shift_amount
         //     lconst some_constant
         ...
         //   aloadi (dataAddrPointer)
         //       aload (array object)
         //   lmul/lshl OR array_index (offset == offset2)
         //     i2l
         //       iload array_index
         //     lconst mul_stride/shift_amount
         offset2 = offset;
      ...
      if (offset2->getOpCodeValue() == TR::lmul || offset2->getOpCodeValue() == TR::lshl)
         {
         ...
         {
         if (offset2->getOpCodeValue() == TR::i2l)
            return offset2->getFirstChild();
         else
            return offset2;
         }
